...
description: Due to maximization operation in DQL, the network always overestimate the value. A solution to this is to use double DQL. We can further perform DQL in a distributed fashion as in Gorila. We discuss these extensions in this lecture. 
videoID: 36e_WTwl7XM 
