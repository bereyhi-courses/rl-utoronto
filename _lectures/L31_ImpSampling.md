...
tldr: "Importance Sampling"
stat: lec
# for lectures stat: lec
description: We can learn the optimal policy while playing with another policy. This is what we call off-policy learning. The key statistical toll that let us do that is Importance Sampling. We learn how we can do it for a general case. 
videoID: 9WOqQhR8IiE 
