...
description: We look at DPG approaches as an alternative AC approach. In these approaches, the policy net directly returns the action, not the distribution. This enables us to work off-policy, improving the sample efficiency.
videoID: MWzixxXgclI 
